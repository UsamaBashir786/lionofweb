    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
      ...
      ?>
        ...
        <div class="<?php echo $border_classes; ?>" data-aos="fade-<?php echo $direction; ?>" data-aos-delay="<?php echo $delay; ?>" data-aos-duration="800">
          ...
          <a href="<?php echo htmlspecialchars($item['link_url']); ?>" class="text-blue-600 hover:text-blue-800 text-sm font-medium mt-2 inline-block transition duration-300">Read More</a>
        </div>
      <?php
          $item_count++;
        endforeach;
