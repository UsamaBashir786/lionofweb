...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  if (empty($error_message)) {
    ...
    $result = addCategory($conn, $name, $slug, $description, $icon_path, $is_active);
    ...
    if ($result) {
      ...
      $error_message = "Error adding category to database. It may already exist.";
    }
  }
}
?>
...
<head>
  ...
  <title>Add Category - NewsHub Admin</title>
                  ...
                  <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                    ...
                    <div class="sm:col-span-3">
                      <label for="slug" class="block text-sm font-medium text-gray-700">
                        Slug
                        <span class="text-gray-500 text-xs ml-1">(optional - will be generated from name if left blank)</span>
                      </label>
                      <div class="mt-1">
                        <input type="text" name="slug" id="slug" value="<?php echo isset($slug) ? htmlspecialchars($slug) : ''; ?>"
                    ...
                    <div class="sm:col-span-6">
                      ...
                      <div class="mt-1">
                        <textarea id="description" name="description" rows="3"
                          class="shadow-sm focus:ring-blue-500 focus:border-blue-500 block w-full sm:text-sm border-gray-300 rounded-md"><?php echo isset($description) ? htmlspecialchars($description) : ''; ?></textarea>
                      </div>
                      ...
                      <div class="flex items-start">
                        <div class="flex items-center h-5">
                          <input id="is_active" name="is_active" type="checkbox"
                            <?php echo (!isset($is_active) || $is_active == 1) ? 'checked' : ''; ?>
